...
import { FbServisService3 } from '../../services/fbServis.service';
import { Sonuc } from '../../models/sonuc';
import { Component, OnInit } from '@angular/core';

import { map } from 'rxjs/operators'
@Component({
  selector: 'app-ekipmanlarKayit',
  templateUrl: './ekipmanlarKayit.component.html',
  styleUrls: ['./ekipmanlarKayit.component.css']
})
export class ekipmanlarKayitComponent implements OnInit {
  kayitlar: any;
  secKayit: Kayit = new Kayit();
  sonuc: Sonuc = new Sonuc();
  constructor(
    public fbServis: FbServisService3
  ) { }
